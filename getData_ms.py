...
cpyName='MS Azure'
cc=" "
to="mamohta@cisco.com,pranavve@cisco.com"
...
if "Mon" in day:
	info_min_time=datetime.strftime(datetime.now() - timedelta(3), '%m/%d/%Y')+":00:00:00" 
	info_max_time=datetime.strftime(datetime.now() - timedelta(1), '%m/%d/%Y')+":23:59:59"
	info_min_time_thirty=datetime.strftime(datetime.now() - timedelta(33), '%m/%d/%Y')+":00:00:00"
	info_max_time_thirty=datetime.strftime(datetime.now() - timedelta(4), '%m/%d/%Y')+":23:59:59" 

#Calculating Time Ranges to 
else:
	info_min_time=datetime.strftime(datetime.now() - timedelta(2), '%m/%d/%Y')+":00:00:00" 
	info_max_time=datetime.strftime(datetime.now() - timedelta(1), '%m/%d/%Y')+":23:59:59"
	info_min_time_thirty=datetime.strftime(datetime.now() - timedelta(32), '%m/%d/%Y')+":00:00:00"
	info_max_time_thirty=datetime.strftime(datetime.now() - timedelta(3), '%m/%d/%Y')+":23:59:59" 
