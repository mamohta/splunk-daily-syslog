...
for file in os.listdir(folderName):
	...
	# print(item)
	df_raw = df_raw[(df_raw['createReportBy'].str.contains(item))]
	html="<html><style>\
	.Heading\
		{color:black;\
		font-size:12.0pt;\
	...
	for severity in sev:
		...
		df_sev = df_raw[(df_raw['Sev'].str.contains(str(severity))) & (~df_raw['RegEx'].str.contains("no match")) & (~df_raw['Filter'].str.contains("Y"))] #This creates a data frame with all values of sev severity
	...
	# text_file = open("testHtml.html", "w")
